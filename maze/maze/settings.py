...
EXTENSIONS = {
    'maze.extensions.SentryLogging' : -1,
    'spidermon.contrib.scrapy.extensions.Spidermon': 500,
}

ITEM_PIPELINES = {
    "maze.pipelines.DiscordMessenger" : 100,
    "maze.pipelines.MazeImagePipeline" : 200,
    "maze.pipelines.GCSPipeline": 300,
...
SPIDERMON_VALIDATION_MODELS = (
    'maze.validators.MazeItem',
)

SPIDERMON_SPIDER_CLOSE_MONITORS = (
'maze.monitors.SpiderCloseMonitorSuite',
)

SPIDERMON_VALIDATION_DROP_ITEMS_WITH_ERRORS = False
SPIDERMON_PERIODIC_MONITORS = {
'maze.monitors.PeriodicMonitorSuite': 30, # time in seconds
}
